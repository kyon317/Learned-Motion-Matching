"""
Decompressor training script
Fully reproduces the training logic of the original framework
"""
...
# Add resources directory to path to import quat, txform, etc.
...
from models import Compressor, Decompressor
...
if __name__ == '__main__':
    ...
    X = load_features(features_path)['features'].astype(np.float32)
    ...
    def save_compressed_database():
        with torch.no_grad():
            ...
            latent_path = os.path.join(output_dir, 'latent.bin')
    ...
    def generate_animation():
        with torch.no_grad():
            ...
            # Write BVH
            try:
                bvh.save(os.path.join(output_dir, 'decompressor_Ygnd.bvh'), {
                ...
                bvh.save(os.path.join(output_dir, 'decompressor_Ytil.bvh'), {
            ...
            try:
                plt.savefig(os.path.join(output_dir, 'decompressor_X.png'))
            except IOError as e:
                print(e)
            ...
            try:
                plt.savefig(os.path.join(output_dir, 'decompressor_Z.png'))
            except IOError as e:
                print(e)
    ...
    # Train
    writer = SummaryWriter(log_dir=os.path.join(output_dir, 'runs', 'decompressor'))
    ...
    for i in range(niter):
        ...
        if i % 1000 == 0:
            ...
            decompressor_path = os.path.join(output_dir, 'decompressor.bin')
            save_network(decompressor_path, [
