...
if __name__ == '__main__':
    ...
    def generate_predictions():
        with torch.no_grad():
            ...
            try:
                plt.savefig(os.path.join(output_dir, 'stepper_X.png'))
            except IOError as e:
                print(e)
            ...
            try:
                plt.savefig(os.path.join(output_dir, 'stepper_Z.png'))
            except IOError as e:
                print(e)
    ...
    # Train
    writer = SummaryWriter(log_dir=os.path.join(output_dir, 'runs', 'stepper'))
    ...
    for i in range(niter):
        ...
        if i % 1000 == 0:
            ...
            stepper_path = os.path.join(output_dir, 'stepper.bin')
            save_network(stepper_path, [
