...
if __name__ == '__main__':
    ...
    def generate_predictions():
        with torch.no_grad():
            ...
            try:
                plt.savefig(os.path.join(output_dir, 'projector_X.png'))
            except IOError as e:
                print(e)
            ...
            try:
                plt.savefig(os.path.join(output_dir, 'projector_Z.png'))
            except IOError as e:
                print(e)
    ...
    # Train
    writer = SummaryWriter(log_dir=os.path.join(output_dir, 'runs', 'projector'))
    ...
    for i in range(niter):
        ...
        if i % 1000 == 0:
            ...
            projector_path = os.path.join(output_dir, 'projector.bin')
